...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/markov: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/markov ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Dictionary.o: Dictionary.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Dictionary.o Dictionary.cpp
...
${OBJECTDIR}/MarkovState.o: MarkovState.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MarkovState.o MarkovState.cpp

${OBJECTDIR}/StateRange.o: StateRange.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StateRange.o StateRange.cpp
